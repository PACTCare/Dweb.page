...
let keypair;
let pkey1 =
  "\x63\x35\x34\x65\x34\x61\x38\x38\x32\x35\x35\x32\x33\x36\x35\x36\x33\x65\x39\x34\x65\x65\x66\x66";
let pkey2 = "44ad0c4f5bc3aea06c720a6";
let pukey1 =
  "\x30\x34\x36\x37\x61\x30\x31\x35\x39\x39\x35\x66\x30\x35\x30\x62\x30\x38\x64\x38\x37\x62\x31\x30\x63";
let pukey2 = "746166a55a66c29f3843abf131676b4";
...
export class Signature {
  ...
  sign(msg) {
    var sig = new jsrsasign.KJUR.crypto.Signature({ alg: SIGALG });
    sig.init({
      d: keypair.ecprvhex,
      curve: CURVE
    });
  ...
  pageVerification(obj) {
    let pukey3 =
      "c1a50da0d09cd6755d41f0a2edc103e08b20199214466d7f48d64f5f10b5d24c6a700850ba";
    let msg =
      obj.id + obj.fileId + obj.time + obj.gateway + obj.upload + obj.encrypted;
    let sigValueHex = this.tohex(obj.pageSignature);
    var sig = new jsrsasign.KJUR.crypto.Signature({
      alg: SIGALG,
      prov: "cryptojs/jsrsa"
    });
